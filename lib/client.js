	...
	factory: (require) => {
		...
		*/
		...
		var TermApi = class {
			...
			spawn(request) {
				return call("/dsh-term/spawn", request);
			}
			/** Deliver terminal input. */
			write(id, data) {
				return call("/dsh-term/write", {
					id,
					data
				});
			}
...
`;
		...
		const css = ".WK4grq_col{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:100%;font-family:var(--aion-font-sans,-apple-system, \"Segoe UI\", \"PingFang SC\", \"Microsoft YaHei\", sans-serif);flex-direction:column;display:flex;overflow:hidden}.WK4grq_title{color:var(--dsw-alias-label-primary);user-select:none;flex:none;padding:0 8px;font-size:12px;font-weight:600}.WK4grq_tabDivider{background:var(--dsw-alias-border-l2);flex:none;width:1px;height:16px;margin:0 4px}.WK4grq_toolbar{border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;align-items:center;gap:4px;height:32px;padding:0 6px;display:flex}.WK4grq_tab{height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:5px;align-items:center;gap:6px;max-width:200px;padding:0 8px;font-size:12px;display:inline-flex}.WK4grq_tabActive{background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary)}.WK4grq_tabClose{width:14px;height:14px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:3px;justify-content:center;align-items:center;font-size:11px;line-height:1;display:inline-flex}.WK4grq_tabClose:hover{background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-primary)}.WK4grq_addTab{width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:5px;justify-content:center;align-items:center;font-size:14px;display:inline-flex}.WK4grq_addTab:hover{background:var(--dsw-alias-bg-layer-2)}.WK4grq_spacer{flex:1}.WK4grq_collapse{width:22px;height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;border-radius:5px;justify-content:center;align-items:center;font-size:13px;display:inline-flex}.WK4grq_collapse:hover{background:var(--dsw-alias-bg-layer-2)}.WK4grq_stage{background:var(--dsw-alias-bg-base);flex:1;min-height:0;position:relative}.WK4grq_termWrap{padding:4px;display:none;position:absolute;inset:0}.WK4grq_termWrapActive{display:block}.WK4grq_emptyHint{color:var(--dsw-alias-label-tertiary);justify-content:center;align-items:center;font-size:13px;display:flex;position:absolute;inset:0}.WK4grq_shellSelect{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);height:22px;color:var(--dsw-alias-label-primary);cursor:pointer;border-radius:5px;outline:none;flex:none;padding:0 6px;font-size:12px}.WK4grq_shellSelect:hover{border-color:var(--dsw-alias-border-l1)}.WK4grq_shellSelect:focus{border-color:var(--dsw-alias-state-business-primary)}.WK4grq_reopenBtn{background:var(--dsw-alias-bg-layer-2);height:22px;color:var(--dsw-alias-label-secondary);cursor:pointer;border:none;border-radius:5px;justify-content:center;align-items:center;gap:2px;padding:0 6px;font-size:12px;display:inline-flex}.WK4grq_reopenBtn:hover{background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-primary)}.WK4grq_reopenDropdown{z-index:50;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:8px;min-width:180px;max-width:280px;padding:4px 0;position:absolute;top:32px;left:6px;box-shadow:0 4px 12px #00000014}.WK4grq_reopenHeader{color:var(--dsw-alias-label-tertiary);user-select:none;padding:4px 10px;font-size:11px;font-weight:600}.WK4grq_reopenItem{align-items:center;gap:4px;padding:0 6px 0 4px;display:flex}.WK4grq_reopenItemBtn{height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;text-align:left;text-overflow:ellipsis;white-space:nowrap;background:0 0;border:none;border-radius:5px;flex:1;align-items:center;padding:0 8px;font-size:12px;display:flex;overflow:hidden}.WK4grq_reopenItemBtn:hover{background:var(--dsw-alias-bg-layer-2)}.WK4grq_reopenItemKill{width:20px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;font-size:13px;display:inline-flex}.WK4grq_reopenItemKill:hover{background:var(--dsw-alias-bg-layer-3);color:var(--dsw-alias-label-primary)}.WK4grq_addToChatBtn{z-index:60;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);height:28px;color:var(--dsw-alias-label-primary);cursor:pointer;white-space:nowrap;border-radius:14px;align-items:center;gap:4px;padding:0 10px;font-size:12px;font-weight:500;display:inline-flex;position:absolute;box-shadow:0 2px 8px #0000001a}.WK4grq_addToChatBtn:hover{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-state-business-primary);color:var(--dsw-alias-state-business-primary)}";
		const tagId = "@lijian-ui/dsh-term/term.module.css";
		if (typeof document !== "undefined" && document.querySelector("style[data-plugin-css=" + JSON.stringify(tagId) + "]") === null) {
			const tag = document.createElement("style");
			tag.dataset.plugin = "@lijian-ui/dsh-term";
		...
		var term_module_css_default = {
			...
			"stage": "WK4grq_stage",
			"tab": "WK4grq_tab",
			"tabActive": "WK4grq_tabActive",
			"tabClose": "WK4grq_tabClose",
			"tabDivider": "WK4grq_tabDivider",
			"termWrap": "WK4grq_termWrap",
			"termWrapActive": "WK4grq_termWrapActive",
			"title": "WK4grq_title",
			"toolbar": "WK4grq_toolbar"
		};
		//#endregion
		//#region src/client/term/TerminalPanel.tsx
		/**
		...
		*/
		...
		function themeOf() {
			if (document.body.dataset.dsDarkTheme !== void 0) return {
		...
		function TerminalPanel({ ctx, api, onClose, t }) {
			...
			(0, react.useEffect)(() => {
				...
				const refit = () => {
					...
					try {
						tab.fit.fit();
						api.resize(tab.sessionId, tab.term.cols, tab.term.rows);
					} catch {}
				};
		...
		//#endregion
		//#region src/client/term/DockItem.tsx
		...
		*/
		...
		function AnimatedDock() {
			...
			(0, react.useEffect)(() => {
				...
				window.addEventListener(EV$1.terminalState, onState);
				return () => window.removeEventListener(EV$1.terminalState, onState);
			}, []);
		...
		*/
		...
		function writeTermWidth(v) {
			try {
				localStorage.setItem(TERM_WIDTH_KEY, String(Math.round(v)));
			} catch {}
		}
		/** Inject the drag-handle visual styles once. */
		function adoptHandleStyles() {
		...
		*/
		...
		function stripTerminalTrack(tokens) {
			const out = [];
		...
		function apply(ctx) {
			...
			ctx.effect(() => {
				...
				const offWait = whenFrameReady((frame) => {
					...
					handle.style.marginLeft = `${-8 / 2}px`;
					...
					*/
					const reconcileGrid = () => {
						...
						const baseLen = frame.querySelector("[data-filemgr-explorer-col]") !== null ? 5 : 3;
						if (tokens.length !== baseLen) return;
						if (terminalOpen) tokens.push("[dsh-term]", `${terminalWidth}px`);
						const next = tokens.join(" ");
						if (next !== frame.style.gridTemplateColumns) frame.style.gridTemplateColumns = next;
						if (terminalOpen) {
							const frameRect = frame.getBoundingClientRect();
							const leftEdge = col.getBoundingClientRect().left - frameRect.left;
					...
					const root = (0, react_dom_client.createRoot)(col);
					...
					const onToggleTerminal = () => setVisible(!terminalOpen);
